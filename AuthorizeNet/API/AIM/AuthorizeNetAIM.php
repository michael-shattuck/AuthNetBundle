...
class AuthorizeNetAIM extends AuthorizeNetRequest
{
     ...
     *
     * @return AuthorizeNetAIMResponse
     */
    ...
    {
        return new AuthorizeNetAIMResponse($response, $this->_x_post_fields['delim_char'], $this->_x_post_fields['encap_char'], $this->_custom_fields);
    }
