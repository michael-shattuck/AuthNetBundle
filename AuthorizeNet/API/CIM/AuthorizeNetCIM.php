...
class AuthorizeNetCIM extends AuthorizeNetRequest
{
     ...
     *
     * @return AuthorizeNetCIMResponse
     */
    ...
    {
        return new AuthorizeNetCIMResponse($response);
    }
    ...
    {
        $xml = new SimpleXMLElement('<?xml version="1.0" encoding="utf-8"?><'.$request_type.'></'.$request_type.'>');
